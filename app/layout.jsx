...
export const metadata = {
  title: "Chan Kim Kheang — Software Engineer",
  description:
    "Portfolio of Chan Kim Kheang — vibe coder, web developer, Android app developer, and software engineer in Phnom Penh, Cambodia.",
};
